...
function noData(): void { console.log("this is void") }
...
(randomValue02 as string).toUpperCase();
if (typeof randomValue02 === "string") {
    console.log((randomValue02 as string).toUpperCase());    //* Returns MATEO to the console.
} else {
...
// 07. 타입 intersection : 두개의 타입을 동시에 사용
interface Employee {
    employeeID: number;
    age: number;
  }
